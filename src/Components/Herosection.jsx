...
const Herosection = () => {
  return (
    ...
    <div className='py-7 md:mx-20'>
      <h2 className='md:font-[500] font-semibold ml-8 md:pe-0 pe-8 md:ml-0 md:text-xl text-lg'>
    ...
    <div className='md:mx-20'>
        <h1 className='absolute md:top-[24rem] top-[20rem] z-10 uppercase md:text-4xl md:leading-[60px] leading-normal md:font-[600] font-semibold ml-8 md:pe-0 pe-8 md:ml-0 text-2xl'>India’s foremost integrated fund led
