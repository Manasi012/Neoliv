...
const Card = ({ imageUrl, description, buttonText, onClick }) => {
  ...
  return (
    <div className="max-w-sm cursor-pointer md:h-[19rem] h-[18rem] rounded hover:underline overflow-hidden shadow-lg relative" onClick={onClick} data-aos="zoom-in" data-aos-delay="800" data-aos-duration="800">
