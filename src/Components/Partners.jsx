...
import Partners_mobile from "./Partners_mobile";
    ...
    return (
        ...
        <div className="container mx-auto p-4 md:block hidden">
            ...
            {/* {images.map((image, index) => (
                ...
                onMouseLeave={handleMouseLeave}  style={{ transition: 'box-shadow 0.3s', opacity: hoveredImage !== null && hoveredImage !== index ? '0.2' : '1' }}
                >
    ...
    <div
      ...
      style={{ transition: 'box-shadow 0.3s', opacity: hoveredImage !== null && hoveredImage !== index ? '0.3' : '1' }}
    >
      ...
      {hoveredImage === index && (
                    <div
                    className="fixed md:top-2/4 mt-0 left-1/2 md:w-[78%] w-96 transform z-40 md:h-80 h-auto pb-2 md:pb-24 -translate-x-1/2  bg-white border shadow-lg border-blue-950 p-8 rounded-lg"
  ...
  &times;
    ...
    <div className="progress-line mt-2">
        ...
        <div className="status" key={progressIndex}>
            ...
            <p className="text-[14px] font-medium md:pe-0 pe-2">{progressItem.company + ' '}</p> {/* Add space after company */}
        </div>
        ))}
    </div>
    </div>
