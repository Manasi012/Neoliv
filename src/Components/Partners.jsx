      ...
      {hoveredImage === index && (
        <div className='container'>
          <div className="tooltip-container z-30">
            <div className={`tooltip-content mt-12 p-8 md:h-80 pb-24 bg-white border ${hoveredImage === index ? 'mobile-about-full-width' : ''}`} style={{ left:'0%', transform: 'translateX(-20%)', position: 'absolute'}}>
              ...
              <div className='flex justify-center pe-12'>
