  ...
  return (    
   <>
    <div className='bg-custom bg-cover bg-center h-auto md:px-8 px-4 py-10' id="threePillars">
        ...
        <h4 className='md:text-3xl text-4xl text-white font-medium'>Our Key Pillars</h4>
        </div>
      ...
      <div className="p-6 rounded-lg">
        ...
        <div className='my-10 text-white text-lg'>
            <ul className='list-disc space-y-10 ml-4'>
                <li>
                Founded by Mohit Malhotra former (ex MD & CEO of Godrej Properties)
                </li>
                <li>
        ...
        <NavLink to="/professionallybuilt" className="inline-flex items-center hover:text-white text-white font-semibold pt-4 px-4 rounded md:absolute bottom-0">
      Discover
    ...
    <div className="w-full sm:w-1/2 md:w-1/3 p-4 pe-28"  data-aos="fade-up" data-aos-delay="1500" data-aos-duration="800">
      <div className="p-6 rounded-lg">
        ...
        <NavLink to="/financiallysecure" className="inline-flex items-center hover:text-white text-white font-semibold pt-4 px-4 rounded md:absolute bottom-0">
      Discover
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-2 transition-transform duration-6000 ease-in-out transform-gpu hover:scale-110">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
      </svg>
    ...
    <div className="w-full sm:w-1/2 md:w-1/3 p-4 pe-28" data-aos="fade-up" data-aos-delay="1900" data-aos-duration="800" id='ComePillars'>
      <div className="p-6 rounded-lg">
        ...
        <NavLink to="/customercentric" className="inline-flex items-center hover:text-white text-white font-semibold pt-4 px-4 rounded md:absolute bottom-0">
      Discover
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 ml-2 transition-transform duration-6000 ease-in-out transform-gpu hover:scale-110">
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
      </svg>
