...
const Partners_mobile = () => {
  ...
  const tabContents = [
    ...
    // Chandan Kar
    {
      name: "Chandan Kar",
      about:
        "Has managed sales of 30+ projects across asset classes with a sale value of USD 1.5 Bn+. In his last role as CBO, he was managing P&L of USD 250 Mn. He cherishes Ghazals and classical music, and exploring historical and cultural places fuels his wanderlust.",
      progress: [
