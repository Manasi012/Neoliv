...
const About = () => {
  ...
  return (
    <div className="md:p-32 px-6 pt-28 md:pb-10 pb-20">
      ...
      <Slider  {...settings}>
      <div className="card_bg  shadow-md p-5 h-auto border border-indigo-300">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-normal mb-2">Founder</h2>
              <img src={Founder} alt="" />
            </div>
      ...
      <div className="py-10">
      <p className='text-center md:px-44 px-2 md:py-8 py-4 text-indigo-500 leading-10 font-medium text-xl'>"The residential real estate sector in India has been affected with distrust & conflict-driven relationships. The whole experience is stressful and far from being a joyous relationship. Moreover, lack of transparency, secure funding, and corporate governance issues have resulted in loss of credibility."</p>
      </div>
    </div>
  );
};
